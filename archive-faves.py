...
tweetfile = tweetdir + 'favorites.txt'
...
# Get the ID of the last downloaded favorite.
a = {}
...
# Collect all the favorites since the last one.
tweets = api.favorites(since_id=lastID)
